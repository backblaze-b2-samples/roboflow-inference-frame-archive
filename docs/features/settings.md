...
## Purpose
Show what a settings page can look like in Roboflow Frame Archive — a profile,
notification/quota preferences, and a default view — while being explicit that
only the preferences the app can actually honour do anything. Today that is Theme;
the rest is a labelled demonstration.
