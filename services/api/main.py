...
API_TITLE = "Roboflow Frame Archive API"
API_DESCRIPTION = (
    "Local API for Roboflow Frame Archive: configure edge cameras, run Roboflow "
    "Inference detection passes on-device, and archive flagged frames, prediction "
    "JSON, and Parquet summaries to Backblaze B2. This contract documents the "
