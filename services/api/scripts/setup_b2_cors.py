...
def _client():
    ...
    # CORS calls sign more reliably with an explicit region. Region comes from
    # B2_REGION and the endpoint is derived from it — no region literal here.
    return boto3.client(
        "s3",
        ...
        config=Config(signature_version="s3v4", user_agent_extra="b2ai-roboflow-inference-frame-archive"),
    )
