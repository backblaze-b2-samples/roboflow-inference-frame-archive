...
const navItems = [
  ...
  { title: "Cameras", href: "/cameras", icon: Cctv },
  { title: "Detections", href: "/archive", icon: ScanSearch },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-roboflow-inference-frame-archive"
          target="_blank"
